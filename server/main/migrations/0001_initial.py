# Generated by Django 4.2.4 on 2023-10-19 19:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', main.models.CustomCloudinaryField(blank=True, default=None, max_length=255, null=True, verbose_name='profile_picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('completed', 'Completed'), ('in_development', 'In Development')], default='in_development', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='project',
            index=django.contrib.postgres.indexes.GinIndex(fields=['title'], name='title_gin_idx'),
        ),
        migrations.AddIndex(
            model_name='project',
            index=django.contrib.postgres.indexes.GinIndex(fields=['description'], name='description_gin_idx'),
        ),
