...
urlpatterns = [
    ...
    path('project/<int:project_id>/comments/', ProjectCommentsView.as_view(), name='project-comments-list'),
    path('project/<int:project_id>/comments/<int:comment_id>/', CommentDetailView.as_view(), name='comment-detail'),
    ...
    path('likes/', LikeViewSet.as_view({'post': 'create', 'delete': 'destroy'}), name='likes'),
